  ...
  return (
    ...
    <div className="min-h-screen  bg-[url('src/assets/Images/fondo2.png')] bg-no-repeat lg: bg-left bg-contain bg-[#4E598C] ">
                ...
                <div className="flex flex-col items-center justify-center ">
                    ...
                    <div className="bg-white shadow  lg:rounded-none md: rounded-xl lg:px-28 md: px-10 md: pb-10 lg:min-h-screen lg:ms-auto relative md: h-5/6 lg:w-1/2 md: w-5/6  lg:mt-0 md: mt-10">
